...
Kappan ger en komplett översikt av hela projektet och består av följande delar:
...
\section{Resultat}
\label{ch:resultat}
Projektet bestod i att skapa ett visualiseringsvektyg i Inviwo som ska kunna visualisera resultat från elektronstrukturberäkningar. Visualiserings verktyget ska uppfylla kraven från kravspecifikationen. 

I tabell \ref{table:kravlista generella systemet} för en kravlista med några utvalda krav på det generella systemet. För samtliga krav se kravspecifikationen i appendix \ref{appendix:kravspecifikation}. 
...
I tabell \ref{table:kravlista visualisering} ses några av de krav som ställts på delsystemet för visualisering. 
