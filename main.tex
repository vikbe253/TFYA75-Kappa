...
\newcommand{\LIPSgranskatdatum}{2018-05-18}
...
\begin{LIPSdokumenthistorik}
  ...
  \LIPSversionsinfo{0.2}{2018-05-18}{Andra utkast.}{Projektgruppen}{DOK}
...
\includepdf[pages={1},pagecommand=\section{Kravspecifikation}\label{appendix:kravspecifikation}\thispagestyle{empty}]{Kravspecifikation_11.pdf}	\includepdf[pages={2-}]{Kravspecifikation_10.pdf}
