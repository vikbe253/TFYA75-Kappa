...
I projektdirektivet, se appendix \ref{appendix:projektdirektiv}, ges en översiktilig bild av krav som kan komma att ställas på systemet. Utifrån projektdirektivet har projektgruppen skapat en kravspecifikation, se appendix \ref{appendix:kravspecifikation} med de krav som ställs på sytemet och även de generella krav som ställs på projektet och dokumentationen i sin helhet.

Systemet är ett verktyg för att visualiserar olika egenskaper från elektonstrukturberäkningar. Själva visualiseringen kommer ske i programvaran Inviwo. % ref


Systemet är en vidareutveckling av projektet från år 2017.
