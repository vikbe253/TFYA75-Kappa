...
se figur XX, och i inställningsrutan för en processor, %fixa fig
se figur YY.
...
Elektrontäthet visualiseras genom volymsrendering. Det är alltså sannolikheten för att hitta elektronener på olika positioner som visualiseras. Se figur %figur och exempel?
...
\subsubsection{ELF}
Electron Location Function (ELF) visualiseras på liknande sätt som elektrontäthet eftersom även det är volymdata som ska visualiseras. Hur ELF visualiseras beskrivs mer detaljerat i den tekniska dokumentationen, se appendix \ref{appendix:tekniskdokumentation}.

\subsubsection{Tillståndstäthet}
Tillståndstäthet visualiseras med en 2D-graf med energn på x-axeln och tillståndstätheten på y-axeln. Se figur %figur och exempel?.
